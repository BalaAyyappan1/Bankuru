...
const Vision = () => {
  ...
  const getImagePosition = (index: number) => {
    const positions = [
      "2xl:-bottom-25 2xl:-right-20 xl:-bottom-25 xl:-right-20 lg:-bottom-25 lg:-right-20 md:-bottom-25 md:-right-20 bottom-8 -right-18   xl:w-[300px] lg:w-[250px] md:w-[220px] sm:w-[200px] w-[180px]",
      ...
      "2xl:-bottom-31 2xl:-left-32 xl:-bottom-30 xl:-left-30 lg:-bottom-24 lg:-left-24 md:-bottom-24 md:-left-24 bottom-10 -right-15  xl:w-[300px] lg:w-[250px] md:w-[220px] sm:w-[200px] w-[180px]",
