...
const Hero = () => {
  ...
  return (
    <div
      id="home-section"
      className="relative bg-transparent md:h-100dvh h-dvh   w-full  pointer-events-none"
    >
      {/* Middle Contents */}
      ...
      >
        <h1 className="gradient-text xl:text-[70px] lg:text-[60px] md:text-[50px] sm:text-[30px] ipad:text-[1000px] text-[20px] font-semibold xl:leading-[80px] lg:leading-[70px] md:leading-[70px]  xl:max-w-5xl lg:max-w-4xl md:max-w-3xl sm:max-w-md">
